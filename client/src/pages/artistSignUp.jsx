...
const _steps = [
  { name: 'Step 1', href: '#step1', status: 'complete' },
  { name: 'Step 2', href: '#step2', status: 'complete' },
  { name: 'Step 3', href: '#step3', status: 'current' },
  { name: 'Step 4', href: '#step4', status: 'upcoming' },
  { name: 'Step 5', href: '#step5', status: 'upcoming' },
];
...
export function ArtistSignUp() {
  ...
  return (
    <div className="mx-auto px-10 pb-10 max-w-2xl">
      <nav aria-label="Progress" className="mt-10 max-w-full">
      ...
      <form className="space-y-8 divide-y divide-gray-200 mt-5">
